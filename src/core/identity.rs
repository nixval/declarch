...
mod tests {
    ...
    fn test_identity_from_config() {
        let identity = PackageIdentity::from_config("hyprland".to_string(), Backend::Aur);
    ...
    fn test_is_same_package() {
        let id1 = PackageIdentity::from_config("hyprland".to_string(), Backend::Aur);
    ...
    fn test_different_packages() {
        let id1 = PackageIdentity::from_config("hyprland".to_string(), Backend::Aur);
        let id2 = PackageIdentity::from_config("wayland".to_string(), Backend::Aur);
