...
pub fn get_builtin_backends() -> HashMap<String, BackendConfig> {
    ...
    backends.insert(
        ...
        BackendConfig {
            ...
            preinstall_env: None,
            use_rust_fallback: false,
            // Search - yarn search with tab-separated output
            ...
            search_version_key: None,
            search_desc_key: None,
            search_name_col: Some(0),
            search_desc_col: Some(1),
            search_regex: None,
            search_regex_name_group: None,
            search_regex_desc_group: None,
            // Output processing
    ...
    backends.insert(
        ...
        BackendConfig {
            ...
            preinstall_env: None,
            use_rust_fallback: false,
            // Search - pnpm search with JSON output
            search_cmd: Some("pnpm search {query} --json".to_string()),
            search_format: Some(crate::backends::config::OutputFormat::Json),
            search_json_path: None,
            search_name_key: Some("name".to_string()),
            search_version_key: Some("version".to_string()),
    ...
    backends.insert(
        ...
        BackendConfig {
            ...
            // Search - cargo search with regex parsing
            search_cmd: Some("cargo search {query} --limit 20".to_string()),
            search_format: Some(crate::backends::config::OutputFormat::Regex),
            search_json_path: None,
            search_name_key: None,
            search_version_key: None,
            search_desc_key: None,
            search_name_col: None,
            search_desc_col: None,
            search_regex: Some(r#"^(\S+)\s+=\s+"([^"]+)"\s+(.*)$"#.to_string()),
    ...
    backends.insert(
        ...
        BackendConfig {
            ...
            preinstall_env: None,
            use_rust_fallback: false,
            // Search - brew search with whitespace splitting
            search_cmd: Some("brew search {query}".to_string()),
            search_format: Some(crate::backends::config::OutputFormat::SplitWhitespace),
            search_json_path: None,
            search_name_key: None,
            search_version_key: None,
            search_desc_key: None,
